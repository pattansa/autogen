...
5. If you are asked to create an image, please make sure that you create the image as output.png and save the output file in working directory. If the output.ong file is not written, then give the error. Use differnt color for different types of data in the output file.
